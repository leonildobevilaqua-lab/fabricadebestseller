...
console.log("Testing with key ending in:", key === null || key === void 0 ? void 0 : key.slice(-4));
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const result = yield model.generateContent("Hello 2.5");
        ...
        try {
            ...
            const result = yield model.generateContent("Hello 1.5");
