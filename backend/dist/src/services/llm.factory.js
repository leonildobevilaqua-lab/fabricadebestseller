...
const fallback_provider_1 = require("./llm/fallback.provider");
const getLLMProvider = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    switch (active) {
        ...
        default:
            ...
            const gemini = new gemini_provider_1.GeminiProvider(config.providers.gemini);
            ...
            if (backup) {
                ...
                return new fallback_provider_1.FallbackProvider(gemini, backup, "Gemini", "OpenAI");
            }
            return gemini;
    }
});
