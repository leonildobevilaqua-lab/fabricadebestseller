...
const payment_controller_1 = require("./controllers/payment.controller"); // Emergency Import
...
app.post('/api/purchase-direct', payment_controller_1.createBookGenerationCharge);
// Simple Health Check
...
app.use('/api/purchase', purchase_routes_1.default); // REGISTER NEW ROUTE
