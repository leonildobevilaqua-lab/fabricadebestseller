...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (isLocal)
            console.log(`[PROJECT] DEV MODE DETECTED: Bypassing Credit Check for ${authorName}`);
        ...
        if (contact && contact.email) {
            try {
                ...
                for (let i = leads.length - 1; i >= 0; i--) {
                    const l = leads[i];
                    // Match Email
                    if (((_c = l.email) === null || _c === void 0 ? void 0 : _c.toLowerCase().trim()) === contact.email.toLowerCase().trim()) {
