...
const checkAccess = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isLocal = ((_a = req.headers.host) === null || _a === void 0 ? void 0 : _a.includes('localhost')) || ((_b = req.headers.host) === null || _b === void 0 ? void 0 : _b.includes('127.0.0.1'));
    if (isLocal) {
    ...
    try {
        ...
        for (let i = leads.length - 1; i >= 0; i--) {
            const l = leads[i];
            if (((_c = l.email) === null || _c === void 0 ? void 0 : _c.toLowerCase().trim()) === email.toLowerCase().trim()) {
                leadStatus = l.status;
                if (l.plan)
                    pendingPlan = l.plan;
    ...
    res.json({
        ...
        latestInvoiceStatus,
        latestInvoiceNumber,
        activeProjectId: hasActiveProject ? (_d = (yield (0, queue_service_1.getProjectByEmail)(email.toLowerCase().trim()))) === null || _d === void 0 ? void 0 : _d.id : null,
        // Helper for frontend total sum
        subscriptionPrice: (effectivePlan && ((_f = (_e = SUBSCRIPTION_PRICES[planName]) === null || _e === void 0 ? void 0 : _e[(effectivePlan.billing || 'monthly').toLowerCase()]) === null || _f === void 0 ? void 0 : _f.price)) ||
