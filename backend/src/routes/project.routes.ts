...
router.post('/:id/resume', ProjectController.resumeGeneration);
...
router.get('/:id/download', ProjectController.downloadProjectBook);
router.get('/:id/download-zip', ProjectController.downloadProjectZip);
