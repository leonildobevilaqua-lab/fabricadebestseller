            ...
            <header className="w-full max-w-6xl px-4 pt-4 md:pt-12 pb-4 md:pb-8 text-center flex flex-col items-center">
                ...
                <div className="flex justify-center mb-3 md:mb-6 animate-fade-in">
                    <div className="flex items-center gap-1.5 bg-white/5 border border-white/10 px-3 py-1 md:px-4 md:py-2 rounded-full">
                        ...
                        <span className="text-[9px] md:text-xs font-bold text-slate-300 uppercase tracking-widest">Exclusive Presentation</span>
                    </div>
                </div>
                            ...
                            <div>
                                ...
                                <ul className="space-y-3 md:space-y-4">
                                    <li className="flex items-start gap-4 p-4 bg-white/5 rounded-xl md:rounded-2xl border border-white/5">
                                        ...
                                        <span className="text-xs md:text-base"><strong className="text-white">Complete Book:</strong> 12 chapters, 170+ pages, in Editable Word.</span>
                                    </li>
                                    <li className="flex items-start gap-4 p-4 bg-white/5 rounded-xl md:rounded-2xl border border-white/5">
                                        <TrendingUp className="text-yellow-500 shrink-0 mt-0.5 md:mt-1 w-5 h-5" />
                                        <span className="text-xs md:text-base"><strong className="text-white">9 Title Options:</strong> Created to attract clicks based on mental triggers.</span>
                                    </li>
                                    <li className="flex items-start gap-4 p-4 bg-white/5 rounded-xl md:rounded-2xl border border-white/5">
                                        <Award className="text-yellow-500 shrink-0 mt-0.5 md:mt-1 w-5 h-5" />
                                        <span className="text-xs md:text-base"><strong className="text-white">Cover Material:</strong> Ready-to-use texts for Front/Back flaps.</span>
                                    </li>
                                    <li className="flex items-start gap-4 p-4 bg-white/5 rounded-xl md:rounded-2xl border border-white/5">
                                        <Zap className="text-yellow-400 shrink-0 mt-0.5 md:mt-1 w-5 h-5" />
                                        <span className="text-xs md:text-base"><strong className="text-white">Amazon Arsenal:</strong> Standard synopsis and powerful keywords.</span>
                                    </li>
                                    <li className="flex items-start gap-4 p-4 bg-yellow-500/10 rounded-xl md:rounded-2xl border border-yellow-500/20">
                                        ...
                                        <span className="text-xs md:text-base"><strong className="text-yellow-500">Marketing Bonus:</strong> Professional description for your sales video.</span>
                                    </li>
                                </ul>
                            </div>
                ...
                <section className="w-full py-24 md:py-32 bg-[#0d1428] relative overflow-hidden">
                    ...
                    <div className="max-w-4xl mx-auto px-6 relative z-10">
                        <div className="bg-gradient-to-b from-slate-800 to-slate-900 rounded-[2.5rem] md:rounded-[3rem] p-8 md:p-20 border border-white/10 shadow-[0_0_100px_-10px_rgba(0,0,0,0.5)] text-center">
                            <h2 className="text-xl md:text-5xl font-black mb-8">This ecosystem for the price of a Pizza.</h2>
                            <div className="mb-12">
                            ...
                            <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 text-slate-400 text-[10px] md:text-sm font-medium">
                                <span className="flex items-center gap-2 text-center justify-center"><CheckCircle className="text-green-500 w-4 h-4 md:w-5 md:h-5" /> Satisfaction guaranteed or your money back in 7 days.</span>
                ...
                <section className="w-full py-20 md:py-24 mb-10">
                    <div className="max-w-4xl mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:gap-6">
                            {[
                                { q: "Do I need to write anything?", a: "No. The tool generates everything autonomously using our exclusive AI." },
                                { q: "Does the book come formatted?", a: "Yes, we deliver the file ready in Word for final layout or direct publishing." },
                                { q: "Can I publish on Amazon?", a: "Yes, the creation engine is fully 'Amazon-Ready'." }
                            ].map((faq, i) => (
