...
export const WebinarLaunchV2: React.FC = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Exibe a barra inferior flutuante no mobile após rolar a primeira tela (ex: 400px)
        ...
        <div className="max-w-3xl mx-auto space-y-12">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: "O que acontece se eu não puder assistir ao vivo?", a: "Sem problemas. Todos os inscritos recebem acesso à gravação completa em alta definição para assistir no seu próprio ritmo, além de poderem usar o crédito da ferramenta a qualquer momento." },
