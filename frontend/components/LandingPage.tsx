                ...
                try {
                    ...
                    if (isSubscriber) {
                        ...
                        if (!paymentConfirmedRef.current) {
                            // RISING EDGE LOGIC:
                            // If this is the FIRST check and it's ALREADY active, it's a pre-existing plan.
                            if (!initialStatusChecked) {
                                console.log("INITIAL CHECK: User is ALREADY Active. Marking as pre-existing.");
                                setInitialStatusChecked(true);
                                setWasInitiallyActive(true);
                                return;
                            }

                            // If it was initially active, we ignore subsequent actives (it's just the same old plan)
                        ...
                        // If we checked and it was NOT active, mark as checked and clean.
                        if (!initialStatusChecked) {
                            setInitialStatusChecked(true);
