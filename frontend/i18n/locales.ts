...
export const pt = {
    landing: {
        ...
        faq: [
            ...
            { q: "Quanto custa para gerar um novo livro?", a: "O custo é de apenas R$ 39,90 por geração de livro completo. Não existem mensalidades nem taxas escondidas. Você paga apenas pelo que produzir." },
