    ...
    <div className="bg-white rounded-xl shadow-xl border border-gray-100 p-8 max-w-2xl mx-auto animate-fade-in-up">
      ...
      <div className="space-y-6">
        <div>
          ...
          <input
            ...
            className="w-full px-5 py-4 rounded-xl border border-gray-200 bg-slate-50 focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition-all text-lg"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-5 py-4 rounded-xl border border-gray-200 bg-slate-50 focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition-all text-lg resize-none"
          />
      ...
      <div className="mt-10 flex justify-end">
        <button
          ...
          className={`w-full md:w-auto px-10 py-4 rounded-full font-bold text-white shadow-lg transition-all transform hover:-translate-y-1 ${
            isFormValid 
